...
AddEventHandler('fuel:requestJerryCanPurchase', function()
	...
	if currentCash >= Config.JerryCanCost then
		...
		if not HasPedGotWeapon(ped, 883325847) then
			...
			TriggerServerEvent('fuel:buyJerryCan')
		else
			if Config.UseESX then
...
RegisterNetEvent('fuel:jerryCanPurchased')
AddEventHandler('fuel:jerryCanPurchased', function()
    ShowNotification(Config.Strings.PurchaseJerryCan)
end)

RegisterNetEvent('fuel:purchaseFailed')
AddEventHandler('fuel:purchaseFailed', function()
    ShowNotification(Config.Strings.NotEnoughCash)
end)
